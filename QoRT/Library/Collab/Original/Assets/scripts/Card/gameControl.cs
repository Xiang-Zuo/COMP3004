...
public class gameControl : MonoBehaviour
{
    ...
    public bool checkValidPerStage(List<Card> alist, int stageNum)
    {
        ...
        print("the stage "+ (stageNum+1) + " has card num " + alist.Count);
        ...
        for (int i = 0; i < alist.Count; i++)
        {
            ...
            {
                gameLog.error("stage " + (stageNum+1) + " is not valid duo to foeCard num");
                print("stage " + (stageNum+1) + " is not valid duo to foeCard num");
                alist.Clear();
                return false;
            }
        }
