...
public class Test : MonoBehaviour
{
	...
	//player who want to join in the quest event
    ...
    void setHands_players()
    {
        ...
        p1 = new Player("p1", hand1, Rank.SQUIRE, PlayerType.PLAYER);
        p2 = new Player("p2AI", hand2, Rank.SQUIRE, PlayerType.AI);
        p3 = new Player("p3AI", hand3, Rank.SQUIRE, PlayerType.AI);
        p4 = new Player("p4AI", hand4, Rank.SQUIRE, PlayerType.AI);
    ...
    void storyEvent()
    {
        ...
        //ask if p1 want to be sponser
                ...
                theSponsor =players[1];   //0 is player, 1-3 is AI for now
                print(players[1].getName() + " is the sponsor");
    ...
    void handleQuestEventSponsor(QuestCard aQuestcard, Player aSponsor)
    {
        ...
        {
            Context context;
            context = new Context(new DoISponsorAQuestA());
            context.DoISponsorAQuest();
        }
        else
        {
            bool testValid = true;
